...
const NavBar = () => {
  return (
    ...
    >
...

        {
          clientRole == "client" && (
            <a
              ...
              className={`nav-link text-sm font-medium no-underline transition-colors text-gray-600 hover:text-blue-600"`}
            >
              Mes Reservations
            </a>
          )
      ...
      {clientRole === null ? (<div className="flex items-center gap-4">
